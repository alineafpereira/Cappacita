...
function batalhaPokemon(id1, id2){
    ...
    if (pokemon1.hp != 0 && pokemon2.hp != 0){
        ...
        } else if(pokemon1.tipo == pokemon2.tipo){
    ...
    if (pokemon1.hp != 0 && pokemon2.hp != 0){
        ...
        } else if(pokemon2.tipo == pokemon1.tipo){
...
function pocoes(id){
    ...
    }else if(pokemon.hp > 80 && pokemon.hp < 100){
    const diferenca = 100 - pokemon.hp
    pokemon.hp = pokemon.hp + diferenca
    }
    return `${pokemon.nome} agora tem ${pokemon.hp} de HP.`
    }

module.exports = {salvarPokemons, mostrarPokemons, mostrarPokemon, atualizarPokemon, deletarPokemon, batalhaPokemon, pocoes}